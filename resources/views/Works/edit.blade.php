...
<body>
    ...
    <form class="row row-cols-lg-auto g-3 align-items-center" method="POST" action="{{ route('Works.update', $Works->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" name="work_title" value="{{ old('work_title', $Works->work_title) }}" placeholder="Title">
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" name="work_status" value="{{ old('work_status', $Works->work_status) }}" placeholder="(should be a dropdown)">
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" name="work_category" value="{{ old('work_category', $Works->work_category) }}" placeholder="(also should be a dropdown)">
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    <div class="input-group">
      <textarea class="form-control" name="work_body">{{ old('work_body', $Works->work_body) }}</textarea>
    </div>
  </div>
